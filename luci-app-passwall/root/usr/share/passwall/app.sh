...
start_crontab() {
	...
	# ===== stop/start/restart =====
	add_service_cron "$(config_t_get global_delay stop_week_mode)" "$(config_t_get global_delay stop_time_mode)" "stop" "Configure scheduled tasks：Automatically shut down service。"
